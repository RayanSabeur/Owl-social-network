    ...
    return (
        ...
        <div className="update-container">
          <div className="left-part">
            ...
            {uid === user._id ? (   <UploadImg user={user}/> ): (<div>  <img  src="/img/icons/enveloppe.png" className='img-share'  onClick={handleConversation} alt="envoyer un message privé" /> </div>)}
          {uid === user._id ? (""): (<div>  Envoyer un message privé </div>)}
          </div>
